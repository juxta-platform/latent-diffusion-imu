...
Example usage:
  1) python scripts/eval_vae_1d.py --config configs/imu/vae_1d.yaml --ckpt logs/vae_1d/checkpoints/best-000.ckpt 
  ...
  2) python scripts/eval_vae_1d.py --config configs/imu/vae_1d.yaml --ckpt logs/vae_1d/checkpoints/best-000.ckpt --data_dir data/dataset_processed_overlapped 
