...
By default also writes an HDF5 copy with synced/acce and synced/gyro
replaced by the LDM-generated world-frame IMU (template from the IMU
HDF5, or from --cond_input when IMU is parquet). For parquet IMU
sources, also writes a copy with accel_world_* / gyro_world_* replaced
by the generated world-frame IMU.
